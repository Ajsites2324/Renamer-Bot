...
╰─────────────────⍟"""
    ...
    HELP_TEXT = """
<i>𝐖𝐚𝐭𝐜𝐡 𝐕𝐢𝐝𝐞𝐨 𝐇𝐨𝐰 𝐭𝐨 𝐔𝐬𝐞 𝐌𝐞 <a href='https://t.me/papa_bol_sakteho'>[ creator ]</a></i>\n
...
╭────[🔅𝐀ᴊᴇᴇᴛ Bᴏᴛꜱ🔅]───⍟
│
├<b>🤖 Bot Name : <a href='https://t.me/Ajrenamer_bot'>𝙍𝙀𝙉𝘼𝙈𝙀 𝘽𝙊𝙏</a></b>
│
├<b>📢 Channel : <a href='https://t.me/about_ajeet'>𝘾𝙡𝙞𝙘𝙠 𝙝𝙚𝙧𝙚</a></b>
│
├<b>👥 Version : <a href='https://t.me/TeleRoid_Renamer_bot'>𝗢𝗳𝗳𝗶𝗰𝗶𝗮𝗹 𝗕𝗼𝘁 </a></b>
│
├<b>💢 Source : <a href='https://t.me/tpn_chatroom'>𝗖𝗹𝗶𝗰𝗸 𝗵𝗲𝗿𝗲</a></b>
│
...
│
├<b>👨‍💻 Developer : <a href='https://t.me/papa_bol_sakteho'>➤⃝✖‿✖•Ajͥeeͣtͫ</a></b>
│
├<b>🚸 Powered By : <a href='https://t.me/ajeet_bots'>𝗔𝗝𝗘𝗘𝗧 𝗕𝗼𝗧𝘀</a></b>
│
╰──────[Thanks 😊]───⍟"""
    ...
    UPLOAD_SUCCESS = "<u><i>Tʜᴀɴᴋᴀ Fᴏʀ Usɪɴɢ ᴍᴇ❤ @ABOUT_AJEET</i></u>"
    ...
    CONTACT_MY_DEVELOPER = "<i>Something Wrong Contact in Support Group @TPN_CHATROOM 😑</i>"
    START_TEXT = "<i>This is a Fastest File Renamer and Converter Bot With Permanant Thumbnail Support💯</i>"
    UPGRADE_TEXT = "<b>To upgrade your subscription <a href='https://t.me/PAPA_BOL_SAKTEHO'>[ Click Here]</a></b>"
